...
const Footer = () => {
  return (
    <footer className="bg-volt-black text-white">
      <div className="volt-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">Your trusted source for premium electronics and tech gadgets.</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/category/gaming" className="text-gray-400 hover:text-white transition-colors">
                  Gaming
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-gray-400 text-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>© 2025 VoltMart. All rights reserved.</p>
